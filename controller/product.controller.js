...
const updateProductById = async (req, res) => {
    const response = await ProductsServices.updateProductById(req.params.id, req.body);
    return res.json({
...
const response = await ProductsServices.getProductByCategoryId(req.params.category);
return res.json({
...
module.exports = { getProducts, addProduct, getProductById, deleteProducrtById, updateProductById, getProductsbyname, getProductsByCostRange,getProductByCategoryId }